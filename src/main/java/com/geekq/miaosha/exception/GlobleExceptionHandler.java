...
public class GlobleExceptionHandler {
    ...
    public ResultObject<String> exceptionHandler(HttpServletRequest request , Exception e){
        e.printStackTrace();
        if(e instanceof GlobleException){
            GlobleException ex= (GlobleException)e;
            return ResultObject.error(ex.getStatus());
            ...
            return ResultObject.error(SESSION_ERROR);
        }else {
            return ResultObject.error(SYSTEM_ERROR);
        }
    }
}
