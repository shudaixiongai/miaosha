...
public class MQConfig {
    ...
    @Bean
    public TopicExchange miaoshaExchage(){
    ...
    public Binding registerBinding() {
        return BindingBuilder.bind(testQueue()).to(topicExchage()).with("topic.register");
    }

    @Bean
    public Binding miaoshaBinding() {
        return BindingBuilder.bind(miaoshaQueue()).to(miaoshaExchage()).with("topic.miaosha");
    }
    /**
